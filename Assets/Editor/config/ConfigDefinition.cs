...
")]
    ...
    public class EquipConfig
    {
        ...
        public int hurt_increase { get; set; }
        public int hurt_reduce { get; set; }
        public int per_jingzhun { get; set; }
        public int per_baoji { get; set; }
        public string per_pofang { get; set; }
        public int per_mianshang { get; set; }
        public int per_pvp_hurt_increase { get; set; }
        public int per_pvp_hurt_reduce { get; set; }
        public int can_strengthen { get; set; }
        public int can_flush { get; set; }
        ...
        public int bag_type { get; set; }
        public int is_display_role { get; set; }
        public int guild_storage_score { get; set; }
        public int is_rare { get; set; }
        public int show_level { get; set; }
        public int special_show { get; set; }
        public int is_texiao { get; set; }
        public int rarefloating { get; set; }
        public int shield_button { get; set; }
    }
