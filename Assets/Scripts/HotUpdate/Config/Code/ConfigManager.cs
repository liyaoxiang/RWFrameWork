namespace Config
{
    public class ConfigManager
    {
        public ConfigManager()
        {
            ...
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<InitiativeConfig>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<PassivityConfig>();
        ...
        public static void LoadAllConfigsByAddressable(string directory)
        {
            ...
            Config.InitiativeConfig.DeserializeByAddressable(directory);
            Config.PassivityConfig.DeserializeByAddressable(directory);
        ...
        public static void LoadAllConfigsByFile(string directory)
        {
            ...
            Config.InitiativeConfig.DeserializeByFile(directory);
            Config.PassivityConfig.DeserializeByFile(directory);
        ...
        public static System.Collections.IEnumerator LoadAllConfigsByBundle(string directory, string subFolder)
        {
            ...
            yield return Config.InitiativeConfig.DeserializeByBundle(directory, subFolder);
            yield return Config.PassivityConfig.DeserializeByBundle(directory, subFolder);
